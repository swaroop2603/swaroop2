"""
Django settings for hostedscan project.
...
SECRET_KEY = 'django-insecure-7wnk+6@^pocv3vnfj1-rlonzp361*vk&b@-&f_=+6ia=7ny795'
...
WSGI_APPLICATION = 'hostedscan.wsgi.application'
